...
class ChecklistController:
    ...
    def submit_checklist_completion(self, completed_items: list[str], allow_incomplete: bool) -> bool:
        """
    ...
    def update_checklist_customization(self, new_items: list[dict], removed_items: list[dict]) -> bool:
        """
        ...
        """
        return self.checklist_model.customize_checklist(new_items=new_items, removed_items=removed_items)
